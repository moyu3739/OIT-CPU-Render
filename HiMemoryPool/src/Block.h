...
class _Block{
    using Block_t = _Block<size>;

public:
    _Block() = delete; // disable default constructor

    _Block(const Block_t& other) = delete; // disable copy constructor

    _Block(const Block_t&& other) = delete; // disable move constructor

    ~_Block() = delete; // disable destructor
